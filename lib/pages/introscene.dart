  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      Align(
          ...
          child: Text('Welcome', style: TextStyle(color: Colors.red[800], fontSize: 30, fontWeight: FontWeight.w500))),
      const SizedBox(
        height: 10,
      ),
      Align(
          ...
          child: Text('Thank you for downloading FitMate',
              style: TextStyle(color: Colors.red[800], fontSize: 20, fontWeight: FontWeight.w400))),
      const SizedBox(
        height: 10,
      ),
      const Align(
        ...
        children: [
          Align(
              ...
              child: Text('Please choose your current activity level below',
                  style: TextStyle(color: Colors.red[800], fontSize: 15, fontWeight: FontWeight.w400))),
          RadioListTile(
